...
public abstract class ServerWorld extends World {
	...
	public <T extends ParticleEffect> int spawnParticles(T particle, boolean force, boolean important, double x, double y, double z, int count, double dx, double dy, double dz, double speed) { throw new UnsupportedOperationException(); }
